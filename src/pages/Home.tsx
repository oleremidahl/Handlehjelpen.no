...
const Home = () => {
  ...
  const faqs = [
      { question: 'Hva er deres leveringsområde?', answer: 'Vi leverer i en radius på 10 km fra Rema 1000 vestnes. Ved ønsker om levering utenfor dette ber vi deg kontakte oss på mail: kontakt@handlehjelpen.no eller tlf: 489 12 203 så finner vi en ordning. ' },
      ...
      { question: 'Tar dere imot spesialbestillinger eller allergier? ', answer: 'Allergier kan spesifiseres i bestillingen. Om du ønsker en bestilling av unormal størrelse eller skiller seg fra normale bestillinger kan du kontakte oss på mail: kontakt@handlehjelpen.no eller tlf: 489 12 203 så finner vi en ordning sammen. '},
